...
// Intercepta a comunicação com o banco para injetarmos cenários controlados
...
// Limpa configurações e contadores dos mocks
beforeEach(() => {
  vi.clearAllMocks();
});
...
describe('Unitário: Sorteio (/draw-teams)', () => {
  ...
  // Valida o bloqueio quando o cliente esquece de enviar os IDs dos jogadores
  ...
  // Testa a regra de negócio de escassez: deve haver no mínimo um goleiro por time
  ...
  // Testa o fluxo principal: sorteio bem-sucedido com quantidade suficiente de goleiros e jogadores de linha
